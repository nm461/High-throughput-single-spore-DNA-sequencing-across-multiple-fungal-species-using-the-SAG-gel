...
#$ -pe def_slot 8
#$ -o /home/nm461/ANMDAx1sassemblyout/logs/SPOREAssembly.out
#$ -e /home/nm461/ANMDAx1sassemblyout/logs/SPOREAssembly.log
...
# Directories & inputs
# =========================
OUT_ROOT="$HOME/ANMDAx1sassemblyout"
SIF_DIR="$HOME/sif_images"
DATA_DIR="$HOME/spore1All/sag/spore_1_sc/AN"
