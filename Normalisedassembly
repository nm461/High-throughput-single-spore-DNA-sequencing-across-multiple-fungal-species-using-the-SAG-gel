...
#$ -pe def_slot 8
#$ -o /home/nm461/normalisedassembly/250k/logs/AndeepNorm250k.out
#$ -e /home/nm461/normalisedassembly/250k/logs/AndeepNorm250k.log
...
# Directories & inputs
# =========================
OUT_ROOT="$HOME/normalisedassembly/250k/andeep"
SIF_DIR="$HOME/sif_images"
DATA_DIR="$HOME/AN_Deep"
...
OUT_ROOT = os.path.expanduser(os.environ.get("OUT_ROOT","~/AN_Deep/Pipelineout"))
COA_DIR  = os.path.join(OUT_ROOT, "newco-assembly")
